...
class OrderServiceTest extends TestCase
{
     ...
     * @test
     */
    public function sholdNotProcessWhenIsNotAllowed()
    {
     ...
     * @test
     */
    public function sholdNotProcessWhenItemIsNotAvailable()
    {
     ...
     * @test
     */
    public function sholdNotProcessWhenBadWordsContainsBadwords()
    {
     ...
     * @test
     */
    public function sholdProcessWhenCreateOrder()
    {
        ...
        $this->assertNotEmpty($paymentTransaction);
